...
/**
 * Following application is a part of Label Master 4 package. It's purpose is to
 * create a 2 data base, one for machine learning purpose and second- for
 * printing (as a QR) and later on- to be verified by Android app. It uses
 * newest WEKA for convenience purpose- has couple of useful modules. Model
 * machine learning uses old version of WEKA 3.4.1. That is the only version
 * available on Android and both, model and verification app has to have the
 * same version.
 * 
 *
